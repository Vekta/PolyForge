...
**Preview mode (`--preview`):** Stop here and display the plan. Ask with numbered choices:
...
- For features spanning >10 files, delegate independent tasks to subagents to work in parallel
